...
-- EXIST condition subquery'ler ile kullanılır
-- IN ifadesinin kullanımına benzer
-- EXIST ve NOT EXIST ifadeleri de alt sorgudan getirilen değerlerin içerisinde
-- bir değerin olması veya olmaması durumunda işlem yapılmasını sağlar
-- EXIST true/false gibidir. Boolean...
