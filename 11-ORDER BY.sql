...
select * from kisiler ORDER BY adres asc -- ascending yazmasakta sıralı verir

-- kisiler tablosunu adres'e göre tersten sıralayarak sorgulayınız.

select * from kisiler ORDER BY adres desc -- descending tersten sıralar

-- kisiler tablosunda maaşı büyükten küçüğe sıralayın

select * from kisiler order by maas desc

-- ismi mine olanları maaşa göre azalan sırada sorgula
