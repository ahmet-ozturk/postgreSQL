...
-- Group By cümleciği bir select ifadesinde satırları, sütunları değerlerine göre 
-- özet olarak gruplamak için kullanılır
-- Group By cümleciği her grup başına satır döndürür
-- Grup By genelde AVG(), COUNT(),MAX(),MIN() ve SUM() gibi 
...
-- satılan meyve türüne göre (urun_adi) ürün alan kişi sayısını gösteren sorguyu yazın
